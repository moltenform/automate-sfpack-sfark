...
def runTest():
    ...
    startScript(
        lambda: 0, compressToSfark, getFilenamesAndCheckIfFilesAlreadyExist, runTest, '.sf2', files.getName(__file__)
    )
...
def go():
    startScript(
        checkPrereqsBeforeRun, compressToSfark, getFilenamesAndCheckIfFilesAlreadyExist, runTest, '.sf2',
